...
#Introduction
#In this report, I mainly focus on the black population age from 15 to 64, and the number of the black population in jail.
#I also use some data and variables about the white to compare with the black population. 
